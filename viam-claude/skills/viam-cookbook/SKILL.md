...
| Local Module Deployment | `references/module-development/local-deployment.md` | `viam module reload-local` for non-registry / under-development modules: full deploy flow, component config, iteration loop, cross-arch build-on-target fallback |
