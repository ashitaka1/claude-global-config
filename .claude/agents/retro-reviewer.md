...
- Could any agents be parallelized?

### Skills (slash commands)
- Could slash commands speed up common tasks?
- Are there project-specific workflows that should be skills?
- Are skill descriptions clear for invocation?

### Workflow opportunities
- Is there project-specific knowledge that should be codified?
- Are there redundancies across CLAUDE.md, skills, and agents?
- Could better permissions reduce friction?

### Documentation separation
- Is CLAUDE.md focused on workflow/process?
- Is project_spec.md handling technical/architectural concerns?
- Is README.md focused on user-facing documentation?
...
#### High Priority
[Changes that would significantly improve workflow]
